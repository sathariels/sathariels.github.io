...
The site is plain HTML, CSS, and a small progressively enhanced JavaScript file. It has no runtime dependencies, framework, or package installation step. All content and technical figures are available without JavaScript. Six small blue pixel lilies accent Selected Work, SageRec, Shadow Index, Experience, About, and Contact. They sit in the margins on wide screens; on narrower screens, they use section spacing and the footer. Inter and IBM Plex Mono load with `font-display: swap` from Google Fonts, with system fallbacks.
